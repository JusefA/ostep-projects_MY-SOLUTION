...
main(int argc, char *argv[]) {
  ...
  12:	53                   	push   %ebx
    ...
    int rc = fork();
  13:	bb a0 86 01 00       	mov    $0x186a0,%ebx
main(int argc, char *argv[]) {
  18:	51                   	push   %ecx
  19:	81 ec 88 00 00 00    	sub    $0x88,%esp
    int x1 = getreadcount();
  1f:	e8 57 03 00 00       	call   37b <getreadcount>
  24:	89 85 74 ff ff ff    	mov    %eax,-0x8c(%ebp)
    int rc = fork();
  2a:	e8 bc 02 00 00       	call   2eb <fork>
  ...
  45:	56                   	push   %esi
  46:	6a 04                	push   $0x4
  48:	e8 be 02 00 00       	call   30b <read>
    for (i = 0; i < 100000; i++) {
  4d:	83 c4 10             	add    $0x10,%esp
  50:	83 eb 01             	sub    $0x1,%ebx
  53:	75 eb                	jne    40 <main+0x40>
    }
    // https://wiki.osdev.org/Shutdown
    // (void) shutdown();

    if (rc > 0) {
  55:	85 ff                	test   %edi,%edi
  57:	7e 21                	jle    7a <main+0x7a>
	(void) wait();
  59:	e8 9d 02 00 00       	call   2fb <wait>
	int x2 = getreadcount();
  5e:	e8 18 03 00 00       	call   37b <getreadcount>
	total += (x2 - x1);
  63:	2b 85 74 ff ff ff    	sub    -0x8c(%ebp),%eax
	printf(1, "XV6_TEST_OUTPUT %d\n", total);
  69:	52                   	push   %edx
  6a:	50                   	push   %eax
  6b:	68 c8 07 00 00       	push   $0x7c8
  70:	6a 01                	push   $0x1
  72:	e8 e9 03 00 00       	call   460 <printf>
  77:	83 c4 10             	add    $0x10,%esp
    }
    exit();
  7a:	e8 74 02 00 00       	call   2f3 <exit>
  7f:	90                   	nop
...
malloc(uint nbytes)
{
 ...
 736:	56                   	push   %esi
 737:	e8 47 fc ff ff       	call   383 <sbrk>
  if(p == (char*)-1)
